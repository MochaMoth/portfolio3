	...
	return (
		<Router>
			<Container style={{ color: "white", height: "100%" }}>
				<Segment style={{ height: "100%", backgroundColor: "transparent", border: "none", display: "flex", alignItems: "center", justifyContent: "center" }}>
					...
					<Rail position="left" internal attached className="mobile-navigation" style={{ marginTop: "5px" }}>
						<Navigation mobile />
					</Rail>
				</Segment>
			</Container>
